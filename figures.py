...
def chi2_bin():
    bins = np.array([5, 7, 9, 15, 20, 25, 50, 100])
    g10 = np.array([0.679, 0.967, 1.901, 4.582, 4.749, 2.709, 1.358, 0.698])
    c11 = np.array([0.653, 0.839, 1.590, 2.380, 3.225, 2.798, 1.343, 0.733])
    m11 = np.array([0.674, 0.611, 1.268, 1.477, 1.930, 1.272, 0.794, 0.515])
    bs21 = np.array([0.497, 0.541, 0.902, 2.621, 2.154, 1.487, 0.787, 0.436])
    # sim2sim = np.aray([?, 2.856, ?, ?, ?, ?, ?, ?])
